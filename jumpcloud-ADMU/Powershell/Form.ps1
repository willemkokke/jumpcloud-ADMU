    ...
    <Grid Margin="10,10,10,10">
        ...
        <GroupBox Header="System Migration Options" Width="485" FontWeight="Bold" HorizontalAlignment="Left" Margin="0,395,0,0" Grid.Row="1">
            <Grid HorizontalAlignment="Left" Height="139" Margin="10,0,0,0" VerticalAlignment="Center" Width="465">
                ...
                <Image Name="img_ckey_info" HorizontalAlignment="Left" Height="14" Margin="148,15,0,0" VerticalAlignment="Top" Width="14" Visibility="Hidden" ToolTip="https://console.jumpcloud.com/" />
                <Image Name="img_ckey_valid" HorizontalAlignment="Left" Height="14" Margin="443,15,0,0" VerticalAlignment="Top" Width="14" Visibility="Hidden" ToolTip="Connect Key must be 40chars &amp; not contain spaces" />
                <Image Name="img_apikey_info" HorizontalAlignment="Left" Height="14" Margin="148,45,0,0" VerticalAlignment="Top" Width="14" Visibility="Hidden" ToolTip="https://console.jumpcloud.com/" />
                <Image Name="img_apikey_valid" HorizontalAlignment="Left" Height="14" Margin="443,45,0,0" VerticalAlignment="Top" Width="14" Visibility="Hidden" ToolTip="Correct error" />
        ...
        <GroupBox Header="Account Migration Information" FontWeight="Bold" Margin="490,395,10,58" Grid.Row="1">
            <Grid HorizontalAlignment="Left" Height="66" Margin="1,0,0,0" VerticalAlignment="Top" Width="461">
                ...
                <Image Name="img_localaccount_info" HorizontalAlignment="Left" Height="14" Margin="169,15,0,0" VerticalAlignment="Top" Width="14" Visibility="Visible"/>
                <Image Name="img_localaccount_valid" HorizontalAlignment="Left" Height="14" Margin="432,15,0,0" VerticalAlignment="Top" Width="14" ToolTip="Local account username can't be empty, contain spaces, already exist on the local system or match the local computer name." Visibility="Visible" />
                <Image Name="img_localaccount_password_info" HorizontalAlignment="Left" Height="14" Margin="169,45,0,0" VerticalAlignment="Top" Width="14" Visibility="Visible"/>
                <Image Name="img_localaccount_password_valid" HorizontalAlignment="Left" Height="14" Margin="432,45,0,0" VerticalAlignment="Top" Width="14" Visibility="Visible"/>
            </Grid>
        </GroupBox>
        ...
        <Image Name="JCLogoImg" HorizontalAlignment="Left" Height="45"/>
